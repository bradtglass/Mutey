namespace Mutey.Hue.Client.State.Color
{
    ...
    public class HueColorConverter : JsonConverter<HueColor>
    {
        ...
        {
            return typeToConvert.IsAssignableTo( typeof( HueColor ) );
        }
        ...
        private static HueColor ReadXyColor( ref Utf8JsonReader reader )
        {
            ...
            reader.Read();
            double x = ReadNumeric( "X", ref reader );
            double y = ReadNumeric( "Y", ref reader );
            ...
            double ReadNumeric( string name, ref Utf8JsonReader innerReader )
            {
                ...
                string readName = innerReader.GetString()!;
                ...
                double number = innerReader.GetDouble();
                innerReader.Read();
